...
HerokuPage herokuPage=new HerokuPage();
    ...
    public void delete_butonu_gorunur_oluncaya_kadar_bekler() {
        //Delete butonu implicitly wait suresi icinde gorunur oldugundan bu adımda bir islem yapılmadi
    ...
    public void delete_butonunun_gorunmedigini_test_eder() {
        ...
        try {
            //elementi bulamıycagı ıcın exception fırlatacak bulamadıgı icin testimiz passed olacak
            Assert.assertTrue(herokuPage.deleteButonu.isDisplayed());
